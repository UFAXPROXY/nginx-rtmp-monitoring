...
<xsl:template match="/">
    <html>
        <head>
            <title>UFAX RTMP statistics</title>
        </head>
        <body>
            <xsl:apply-templates select="rtmp"/>
            <hr/>
            Generated by <a href='https://ufapro888s.info/'>
            nginx live</a>&#160;<xsl:value-of select="/rtmp/nginx_rtmp_version"/>,
            <a href="https://ufatop1.net/index.html">nginx</a>&#160;<xsl:value-of select="/rtmp/nginx_version"/>,
